DBoW2
=====
The original source for the functionality to load and save as "t.xt" and ".bin" files is available at the following address:
https://github.com/shinsumicco/DBoW2

I will create the function to load and save as ".bin"....
